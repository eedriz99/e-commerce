...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center p-3 border-b">
      ...
      <button typeof="submit" className="p-2 border ml-auto lg:hidden" 
      onClick={() => menuToggle()}>
        <AiOutlineMenu />
      </button>
      <div id="menuList" className="p-2 hidden absolute right-0 top-14 h-screen z-10 lg:flex lg:basis-3/4 lg:items-center lg:justify-between lg:ml-auto lg:pl-24 bg-slate-200 lg:relative lg:max-h-0 lg:top-0 lg:bg-inherit">
